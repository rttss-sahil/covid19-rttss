        ...
        <div className="row">
          <div className="symptoms__main">
            <div className="symptoms__left">
              <img
                src="assets/images/light/symptoms.png"
                alt=""
            ...
            <div className="symptoms__right">
              ...
              <h4>
                COVID-19 symptoms range from mild to severe. It takes 2-14 days
                after exposure for symptoms to develop. Symptoms may include:
              </h4>
